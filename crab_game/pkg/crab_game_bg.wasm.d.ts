...
export const gamemanager_get_yellow_stars_count: (a: number) => number;
export const gamemanager_get_pink_stars_count: (a: number) => number;
export const gamemanager_get_purple_stars_count: (a: number) => number;
...
export const show_sp1_proof_result: (a: number, b: number, c: number) => void;
